...
public class AutoReplyService extends AccessibilityService {
    ...
    private void wakeAndUnlock() {
        ...
        int flag = PowerManager.ACQUIRE_CAUSES_WAKEUP | PowerManager.SCREEN_BRIGHT_WAKE_LOCK;
        PowerManager.WakeLock wl = pm.newWakeLock(flag, "bright");
